...
Make sure both devices have Wi-Fi and Bluetooth enabled, and that LocalScreen has permission to access the local network.
...
Please visit the privacy policy page: `/en/privacy/`
